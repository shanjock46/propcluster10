...
public class TestBaralla {
	...
	public static void main(String[] args) throws Exception {
		...
		int op = 30;
		inout io = new inout();
		BarallaFrancesa baralla = new BarallaFrancesa(1,false);
		...
		while (op != 0) {
			...
			case 2:// getCartes(): Set(Carta)
				...
				io.writeln("Recorda de crear Baralla Abans de veure les seves cartes");
			...
			case 7: //extreureCarta(): Carta
				if(baralla.getCartes().isEmpty()) io.writeln("No hi ha cartes per extreure");
					...
					io.writeln("S'extreura una carta de manera aleatoria de cartes.");
			...
			case 9: //veurePrimeraCarta(): Carta
				if(baralla.getCartesDescartades().isEmpty()) io.writeln("No hi ha cartes descartades per veure");
					...
					io.writeln("es veura la primera carta de cartes descartades pero no s'extreura de la Baralla");
			...
			case 10: //afegirCartaDescartada(c: Carta)
				io.writeln("Introdueix la informacio de la carta a afegir:");
