...
public abstract class EstadistiquesGenerals {
	...
	public Integer getTotalRondesJugades() {
		if (totalRondesJugades != -1) return totalPartidesJugades;
		return 0;
	}
	...
	public Integer getTotalJugadorsParticipants() {
		if (totalJugadorsParticipants != -1) return totalPartidesJugades;
		else return 0;
	}
	...
	public ArrayList<Object> carregaEstadístiquesGenerals() {
		ArrayList <Object> est = new ArrayList <Object>();
		if (totalPartidesJugades != -1) est.add(totalPartidesJugades);
		else est.add(0);
		if (totalJugadorsParticipants != -1) est.add(totalJugadorsParticipants);
		else est.add(0);
		if (totalRondesJugades != -1) est.add(totalRondesJugades);
		else est.add(0);
