...
public class inout {
	private final char cr = '\r', eof = '\uFFFF', nl = '\n', sp = ' ';
	...
	public void write(boolean value, int width) throws Exception {
	...
	public void write(double value, int width) throws Exception {
	...
	public void write(String value, int width) throws Exception {
	...
	public void writeln(boolean value, int width) throws Exception {
		write(value, width);
		writeln();
	}
	...
	public void writeln(char value, int width) throws Exception {
		write(value, width);
		writeln();
	}
	...
	public void writeln(double value, int width) throws Exception {
		write(value, width);
		writeln();
	}
	...
	public void writeln(String value, int width) throws Exception {
		write(value, width);
		writeln();
	}

	public void writesame(char value, int number) throws Exception {
	...
	public int readint() throws Exception {
		...
		while (digit())
			symbol.append(read());
		Integer numeral = new Integer(symbol.toString());
